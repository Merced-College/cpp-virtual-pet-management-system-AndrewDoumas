...
int main() {
    ...
    dog1.setBreed("Rotweiler");
    std::cout << "\nDog Info:\n";
    dog1.printInfo();
    dog1.makeSound();

    //polymorphism
    Pet* petPtr = new Dog("Fluffy", "Dog", 12,9,"Poodle"); // Upcasting
    std::cout << "\nUsing polymorphism:\n";
    petPtr->printInfo(); // Calls Dog's printInfo
    petPtr->makeSound(); // Calls Dog's makeSound
